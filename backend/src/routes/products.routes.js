...
r.post('/', async (req, res) => {
  try {
    const { name, description = null, unitPrice, category = null, type = null } = req.body || {};
...
r.patch('/:id', async (req, res) => {
  try {
    const { name = null, description = null, unitPrice = null, category = null, type = null } = req.body || {};
